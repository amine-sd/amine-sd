...
![Recherche](https://img.shields.io/badge/Recherche-Stage_de_fin_d'études_·_6_mois_·_2027-2A5686?style=flat-square)
![Lieu](https://img.shields.io/badge/Caen-mobile_France_entière-5A6675?style=flat-square)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Amine_Saidi-0A66C2?style=flat-square&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/amine-saidi-1b2343294/)
[![Mail](https://img.shields.io/badge/Mail-aminesd710@gmail.com-1F7356?style=flat-square&logo=gmail&logoColor=white)](mailto:aminesd710@gmail.com)
...
**1.** &nbsp;<ins>**[agent-remediation-pipeline](https://github.com/amine-sd/agent-remediation-pipeline)**</ins> &nbsp;`Python` `LLM` `dbt` `DuckDB`

Un agent LLM enquête sur les pannes d'un pipeline de données et décide s'il peut les corriger seul.
Le dépôt mesure surtout **quand il a eu tort** : 25 scénarios à vérité terrain exacte, une politique
d'autonomie écrite avant la première mesure, une ligne de base sans LLM, un garde-fou d'exécution,
et une intégration continue qui rejoue tout hors ligne.
...
classification de la technique de gravure (**ResNet50** affiné), attribution du graveur sur
embeddings gelés (DINOv2), et un moteur de recherche en langage naturel servi par un LLM local.
...
*Deployment* Kubernetes à chaque commit. L'environnement d'intégration est lui-même conteneurisé.
...
![C](https://img.shields.io/badge/C_/_C++-00599C?style=flat-square&logo=cplusplus&logoColor=white)
